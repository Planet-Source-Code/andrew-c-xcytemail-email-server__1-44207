...
'                MsgBox "Socket Error : " & nRet
    ...
    If frmAdmin.AutoDNS.value = 0 Then
       If frmAdmin.UserDNS = "" Or frmAdmin.DNSSet1.Text = "" Then GoTo skipman
       sDNS(0) = frmAdmin.UserDNS
    End If
skipman:
...
Public Function MX_Query() As String
    ...
    If MX_Query = "" Then MX_Query = ms_Domain
End Function
